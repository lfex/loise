...
(deftest get-dimensions
  (is-equal '(32 16) (loise-ascii:get-dimensions (def-opts)))
...
(deftest get-simplex-point
  ...
  (is-equal '#((0 1) "n") (loise-ascii:get-simplex-point 0 1 (tiny-opts)))
  (is-equal '#((0 2) ".") (loise-ascii:get-simplex-point 0 2 (tiny-opts)))
  (is-equal '#((2 0) "^") (loise-ascii:get-simplex-point 2 0 (tiny-opts))))
