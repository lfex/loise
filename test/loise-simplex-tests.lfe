...
(deftest point-without-opts
  (is-equal 0.0
            (lutil-math:round (loise-simplex:point '(0 0) '(256 256) 1) 2))
  (is-equal 0.31
            (lutil-math:round (loise-simplex:point '(127) '(256) 1) 2))
  (is-equal 0.14
            (lutil-math:round (loise-simplex:point '(127 64) '(256 256) 1) 2))
  (is-equal 0.21
            (lutil-math:round
             (loise-simplex:point '(127 64 32) '(256 256 256) 1) 2)))
